...
@app.route('/temperature/celciusToKelvin')
...
@app.route('/temperature/fahrenheitToCelcius')
...
@app.route('/temperature/fahrenheitToKelvin')
...
@app.route('/temperature/kelvinToFahrenheit')
...
@app.route('/temperature/kelvinToCelcius')

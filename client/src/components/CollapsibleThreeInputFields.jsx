  ...
  return (
    ...
    <>
     <div style={{borderColor:"white",borderWidth:1}}>
        <button style={{color:"white"}}  onClick={()=>{resetResultAction();handleAccordion(props.id, props.service)}} className="w3-padding-16 w3-theme w3-button w3-block w3-left-align ">
            {props.title}
        </button>
